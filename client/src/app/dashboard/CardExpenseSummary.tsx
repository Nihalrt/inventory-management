...
const CardExpenseSummary = () => {
    ...
    //     console.error({message: "expenseSummary Data is Empty"})
    // }
        ...
        {isLoading ? (
            ...
            <>
                ...
                <div>
                    <hr />
                    {expenseSummary && (
                        <div className='mt-3 flex justify-between items-center px-7 '>
                            <div className="pt-2">
                                <p className="pt-2">
                                    Average:{" "}
                            ...
                            <span className="flex items-center mt-2">
                                <TrendingUp className="mr-2 text-green-500"></TrendingUp>
                                30%
                            </span>
                        </div>
