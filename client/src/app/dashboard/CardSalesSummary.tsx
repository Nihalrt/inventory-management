...
const CardSalesSummary = () => {
    ...
    const averageChangeInPercentage = salesData.reduce((acc, curr, _, array) => {
    ...
    return (
        <div className="row-span-3 xl:row-span-6 bg-white shadow-md rounded-2xl flex-col justify-between">
            {isLoading ? (
                        ...
                        <div className="flex justify-between items-center mb-6 px-7 mt-5">
                            <div className="text-lg font-medium">
                                ...
                                <span className="text-green-500 text-sm ml-2">
                                    ...
                                    {averageChangeInPercentage.toFixed(2)}%
                                </span>
                            </div>
                            <select className="shadow-sm border border-gray-300 bg-white p-2 rounded" value={timeframe} onChange={(e) => {setTimeframe(e.target.value)}}>
