...
const CreateProduct = ({isOpen, onClose, onCreate}: CreateProductProps) => {
    ...
    const inputCssStyles = "block mb-2 p-2 w-full border-gray-500 border-2 rounded-md"
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-20">
        <div className='relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                {/* {CREATE ACTIONS} */}
                <button type="submit" className="mt-4 px-4 py-4 text-white bg-blue-600 rounded hover:bg-blue-700">Create</button>
                <button onClick={onClose} type="button" className="ml-2 px-4 py-4 text-white bg-gray-500 rounded hover:bg-gray-700">Cancel</button>
